    ...
    return (
        <Container
            ...
            <div className="max-w-2xl text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
                ...
                <p>
                    First things first - we&rsquo;re already married. You are being invited to our reception. We were wed in 2021 with (almost) no witnesses. Here&lsquo;s a picture of us on our wedding day.
                </p>
                <p>
